...
export default function Music(props) {
  let PlayingButton;
  //Doing with if ternary
  // props.playing ? PlayingButton = <FaStopCircle size='45px' className='has-text-white' /> : PlayingButton = <FaPlayCircle size='45px' className='has-text-white' />
